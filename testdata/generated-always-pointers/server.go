...
func (bbp *PrintRequest) MarshalBebopTo(buf []byte) int {
	...
	if bbp.Print != nil {
		...
		tmp3135 := (*bbp.Print); at += tmp3135.Size()
	}
	return at
}
...
func (bbp *PrintRequest) UnmarshalBebop(buf []byte) (err error) {
	...
	for {
		...
		case 1:
			...
			tmp3143 := ((*bbp.Print)); at += tmp3143.Size()
		default:
			return nil
		}
	}
...
func (bbp *PrintRequest) MustUnmarshalBebop(buf []byte) {
	...
	for {
		...
		case 1:
			...
			tmp3149 := ((*bbp.Print)); at += tmp3149.Size()
		default:
			return
		}
	}
...
func (bbp *PrintRequest) Size() int {
	...
	if bbp.Print != nil {
		bodyLen += 1
		tmp3162 := (*bbp.Print); bodyLen += tmp3162.Size()
	}
	return bodyLen
}
...
func (bbp *AddRequest) MarshalBebopTo(buf []byte) int {
	...
	if bbp.Add != nil {
		...
		tmp3186 := (*bbp.Add); at += tmp3186.Size()
	}
	return at
}
...
func (bbp *AddRequest) UnmarshalBebop(buf []byte) (err error) {
	...
	for {
		...
		case 1:
			...
			tmp3200 := ((*bbp.Add)); at += tmp3200.Size()
		default:
			return nil
		}
	}
...
func (bbp *AddRequest) MustUnmarshalBebop(buf []byte) {
	...
	for {
		...
		case 1:
			...
			tmp3205 := ((*bbp.Add)); at += tmp3205.Size()
		default:
			return
		}
	}
...
func (bbp *AddRequest) Size() int {
	...
	if bbp.Add != nil {
		bodyLen += 1
		tmp3235 := (*bbp.Add); bodyLen += tmp3235.Size()
	}
	return bodyLen
}
