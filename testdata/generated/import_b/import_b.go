...
func (bbp *Library) UnmarshalBebop(buf []byte) (err error) {
	...
	for i := uint32(0); i < ln1; i++ {
		...
		tmp5301 := ((bbp.Songs)[k1]); at += tmp5301.Size()
	}
	return nil
}
...
func (bbp *Library) MustUnmarshalBebop(buf []byte) {
	...
	for i := uint32(0); i < ln2; i++ {
		...
		tmp5308 := ((bbp.Songs)[k1]); at += tmp5308.Size()
	}
}
...
func (bbp Library) Size() int {
	...
	for _, v1 := range bbp.Songs {
		bodyLen += 16
		tmp5330 := (v1); bodyLen += tmp5330.Size()
	}
	return bodyLen
}
	...
	for {
		...
		case 3:
			...
			for i3 := range (*bbp.Performers) {
				...
				tmp6096 := (((*bbp.Performers))[i3]); at += tmp6096.Size()
			}
		default:
			return nil
		}
	...
	for {
		...
		case 3:
			...
			for i3 := range (*bbp.Performers) {
				...
				tmp6120 := (((*bbp.Performers))[i3]); at += tmp6120.Size()
			}
		default:
			return
		}
...
func (bbp Song) Size() int {
	...
	if bbp.Performers != nil {
		...
		bodyLen += 4
		for _, elem := range *bbp.Performers {
			tmp6164 := (elem); bodyLen += tmp6164.Size()
		}
	}
	return bodyLen
}
...
func (bbp MediaMessage) MarshalBebopTo(buf []byte) int {
	...
	if bbp.Data != nil {
		...
		tmp6177 := (*bbp.Data); at += tmp6177.Size()
	}
	return at
}
...
func (bbp *MediaMessage) UnmarshalBebop(buf []byte) (err error) {
	...
	for {
		...
		case 2:
			...
			tmp6225 := ((*bbp.Data)); at += tmp6225.Size()
		default:
			return nil
		}
	}
...
func (bbp *MediaMessage) MustUnmarshalBebop(buf []byte) {
	...
	for {
		...
		case 2:
			...
			tmp6255 := ((*bbp.Data)); at += tmp6255.Size()
		default:
			return
		}
	}
...
func (bbp MediaMessage) Size() int {
	...
	if bbp.Data != nil {
		bodyLen += 1
		tmp6291 := (*bbp.Data); bodyLen += tmp6291.Size()
	}
	return bodyLen
}
...
func (bbp SkipTestOldContainer) Size() int {
	...
	if bbp.S != nil {
		bodyLen += 1
		tmp6779 := (*bbp.S); bodyLen += tmp6779.Size()
	}
	if bbp.After != nil {
		bodyLen += 1
		bodyLen += 4
...
func (bbp SkipTestNewContainer) Size() int {
	...
	if bbp.S != nil {
		bodyLen += 1
		tmp6893 := (*bbp.S); bodyLen += tmp6893.Size()
	}
	if bbp.After != nil {
		bodyLen += 1
		bodyLen += 4
