...
exports.Test22 =
  ...
  exports.stringconst =
  exports.boolconst =
  exports.float64nanconst =
  exports.float64ninfconst =
  exports.float64infconst =
  exports.float64const =
  exports.float32const =
  exports.int64const =
  exports.int32const =
  exports.int16const =
  exports.int8const =
...
exports.ExampleMessage =
  ...
  exports.Test2 =
    void 0;
exports.Library = exports.Song = exports.Musician = exports.Instrument = void 0;
//------------------------------------------------------------------------------
// <auto-generated>
...
exports.U2 = {
  ...
  readFrom: function (view) {
    ...
    switch (view.readByte()) {
      ...
      default:
        view.index = end;
        throw new bebop_1.BebopRuntimeError(
          "Unrecognized discriminator while decoding U2"
        );
    }
  },
};
...
exports.ReadOnlyMap = {
  ...
  encodeInto: function (message, view) {
    ...
    if (message.vals != null) {
      ...
      try {
        for (
          var _b = __values(message.vals), _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
...
var EnumU8;
(function (EnumU8) {
  EnumU8[(EnumU8["EnumU81"] = 1)] = "EnumU81";
  EnumU8[(EnumU8["EnumU82"] = 2)] = "EnumU82";
})((EnumU8 = exports.EnumU8 || (exports.EnumU8 = {})));
var EnumByte;
(function (EnumByte) {
  EnumByte[(EnumByte["EnumByte1"] = 1)] = "EnumByte1";
  EnumByte[(EnumByte["EnumByte2"] = 2)] = "EnumByte2";
})((EnumByte = exports.EnumByte || (exports.EnumByte = {})));
var EnumU16;
(function (EnumU16) {
  EnumU16[(EnumU16["EnumU161"] = 1)] = "EnumU161";
  EnumU16[(EnumU16["EnumU162"] = 2)] = "EnumU162";
})((EnumU16 = exports.EnumU16 || (exports.EnumU16 = {})));
var EnumU32;
(function (EnumU32) {
  EnumU32[(EnumU32["EnumU321"] = 1)] = "EnumU321";
  EnumU32[(EnumU32["EnumU322"] = 2)] = "EnumU322";
})((EnumU32 = exports.EnumU32 || (exports.EnumU32 = {})));
exports.EnumU64 = {
  EnumU641: 1n,
  1: "EnumU641",
  EnumU642: 2n,
...
var Enum16;
(function (Enum16) {
  Enum16[(Enum16["Enum161"] = 1)] = "Enum161";
  Enum16[(Enum16["Enum162"] = 2)] = "Enum162";
})((Enum16 = exports.Enum16 || (exports.Enum16 = {})));
var Enum32;
(function (Enum32) {
  Enum32[(Enum32["Enum321"] = 1)] = "Enum321";
  Enum32[(Enum32["Enum322"] = 2)] = "Enum322";
})((Enum32 = exports.Enum32 || (exports.Enum32 = {})));
exports.Enum64 = {
  Enum641: 1n,
  1: "Enum641",
  Enum642: 2n,
...
exports.SomeMaps = {
  ...
  encodeInto: function (message, view) {
    ...
    try {
      for (
        var _h = __values(message.m1), _j = _h.next();
        !_j.done;
        _j = _h.next()
      ) {
    ...
    try {
      for (
        var _l = __values(message.m2), _m = _l.next();
        !_m.done;
        _m = _l.next()
      ) {
        ...
        try {
          for (
            var v0_1 = ((e_4 = void 0), __values(v0)), v0_1_1 = v0_1.next();
            !v0_1_1.done;
            v0_1_1 = v0_1.next()
          ) {
            var _p = __read(v0_1_1.value, 2),
              k1 = _p[0],
              v1 = _p[1];
            view.writeString(k1);
            view.writeString(v1);
    ...
    }
    {
      ...
      for (var i0 = 0; i0 < length0; i0++) {
        ...
        try {
          for (
            var _q = ((e_5 = void 0), __values(message.m3[i0])), _r = _q.next();
            !_r.done;
            _r = _q.next()
          ) {
            ...
            view.writeInt32(k1);
            {
              ...
              for (var i2 = 0; i2 < length2; i2++) {
                ...
                try {
                  for (
                    var _t = ((e_6 = void 0), __values(v1[i2])), _u = _t.next();
                    !_u.done;
                    _u = _t.next()
                  ) {
    ...
    }
    {
      ...
      for (var i0 = 0; i0 < length0; i0++) {
        ...
        try {
          for (
            var _w = ((e_7 = void 0), __values(message.m4[i0])), _x = _w.next();
            !_x.done;
            _x = _w.next()
          ) {
            var _y = __read(_x.value, 2),
              k1 = _y[0],
              v1 = _y[1];
            view.writeString(k1);
            {
    ...
    try {
      for (
        var _z = __values(message.m5), _0 = _z.next();
        !_0.done;
        _0 = _z.next()
      ) {
        var _1 = __read(_0.value, 2),
          k0 = _1[0],
          v0 = _1[1];
        view.writeGuid(k0);
  ...
  readFrom: function (view) {
    ...
    switch (view.readByte()) {
      ...
      default:
        view.index = end;
        throw new bebop_1.BebopRuntimeError(
          "Unrecognized discriminator while decoding List2"
        );
    }
  },
};
  ...
  readFrom: function (view) {
    ...
    switch (view.readByte()) {
      ...
      default:
        view.index = end;
        throw new bebop_1.BebopRuntimeError(
          "Unrecognized discriminator while decoding U"
        );
    }
  },
};
  ...
  readFrom: function (view) {
    ...
    switch (view.readByte()) {
      ...
      default:
        view.index = end;
        throw new bebop_1.BebopRuntimeError(
          "Unrecognized discriminator while decoding List"
        );
    }
  },
};
  ...
  readFrom: function (view) {
    ...
    switch (view.readByte()) {
      case 1:
        return {
          discriminator: 1,
          value: exports.TaggedSubStruct.readFrom(view),
        };
      default:
        view.index = end;
        throw new bebop_1.BebopRuntimeError(
          "Unrecognized discriminator while decoding TaggedUnion"
        );
    }
  },
};
...
exports.Library = {
  ...
  encodeInto: function (message, view) {
    ...
    try {
      for (
        var _b = __values(message.songs), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var _d = __read(_c.value, 2),
